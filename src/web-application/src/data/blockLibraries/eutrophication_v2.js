...
netlogoGenerator['set'] = function (block) {
    ...
    const code = 'to blocks-set\n' +
        ...
        netlogoGenerator.INDENT + 'set language "en"\n' +
        statement_members +
...
netlogoGenerator['text'] = function (block) {
    ...
    const valueMap = {
        "small": netlogoGenerator.SIZE_EUTROPHICATION['SMALL'],
        "medium": netlogoGenerator.SIZE_EUTROPHICATION['MEDIUM'],
        "big": netlogoGenerator.SIZE_EUTROPHICATION['BIG'],
        "yellow": "yellow",
        "blue": "blue",
        "white": "white",
        "cyan": "cyan",
