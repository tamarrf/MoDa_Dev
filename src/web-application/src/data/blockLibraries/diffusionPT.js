...
netlogoGenerator['set_color'] = function (block) {
    ...
    if (color == "laranja"){color = "orange" }
    if (color == "verde"){color = "green" }
    if (color == "azul"){color = "blue" }
    if (color == "anil"){color = "cyan" }
    if (color == "violeta"){color = "violet" }
    if (color == "cinza"){color = "gray" }
    if (color == "preto"){color = "black" }
    if (color == "marrom"){color = "brown" }
