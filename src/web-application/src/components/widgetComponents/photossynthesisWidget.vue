<template>
    <div style="display: grid;">
        <div class="diff-widget">
            ...
            <div class="widget-slider-label">lamp intensity</div>
            <input v-on:input="onTemperatureUpdate" @change="logInteractionData('slider', 'temperature', $event.target.value)" type="range" min="1" max="100" value="50" step="1" class="widget-slider" id="temperature">
            <!-- <div class="temp-widget-label">{{ tempText }}</div> -->
            <div class="temp-widget-value">
                <div class="temperature">{{ temp }}</div><div class="units">%</div>
            </div>
