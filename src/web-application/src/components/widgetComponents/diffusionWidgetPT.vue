    ...
    <div style="display: grid;">
        <div class="diff-widget">
            ...
            <div class="diffusion-complete">
                <button id="diffusionComplete" v-on:click="diffusionClicked" class="ui-buttons" :disabled="completeClicked">Parar Difusão</button>
            </div>
