...
to setup
  ...
  set infectiousness infectiousness-rate
  set fatality fatality-rate
...
to go
  ask people [
    set near-infected one-of people with [condition = "infected"] in-radius contact-radius
    set near-healthy one-of people with [condition = "healthy"] in-radius contact-radius
    set near-recovered one-of people with [condition = "recovered"] in-radius contact-radius
  ]
...
to display-labels
  ...
  if show-recovery-time? [
    ask people with [condition = "infected"] [ set label round recovery-time ]
  ]
  if show-contact-radius? [
    ask people with [condition = "infected"]
      [ ask patches in-radius contact-radius
        [ set pcolor yellow] ]
  ]
end
...
to-report count-healthy
  report count people with [condition = "healthy"]
end

to-report count-infected
  report count people with [condition = "infected"]
end

to-report count-recovered
  report count people with [condition = "recovered"]
end

to-report count-total
  report count people
end

to-report count-deaths
  report deaths
end

to-report count-new-cases
  report new-cases
end
