...
; both wolves and sheep have this
turtles-own [
  energy
  gain-from-food
]
...
to eat-grass  ; sheep procedure
  ...
  if pcolor = green [
    set pcolor brown
    set energy energy + gain-from-food  ; sheep gain energy by eating
  ]
end
...
to eat-sheep  ; wolf procedure
  ...
  if prey != nobody  [                     ; did we get one? if so,
    ...
    set energy energy + gain-from-food     ; get energy from eating
  ]
end

to reproduce
  let breed-reproduce 0
  if breed = sheep [
    set breed-reproduce sheep-reproduce
  ]
  if breed = wolves [
    set breed-reproduce wolf-reproduce
  ]
  if random-float 100 < breed-reproduce [  ; throw "dice" to see if you will reproduce
...
to-report count-sheep
  report count sheep
end

to-report count-wolves
  report count wolves
end
